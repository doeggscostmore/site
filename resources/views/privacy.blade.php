...
@section('page_content')
    ...
    <ul>
        ...
        <li>
            <p>
                ...
                in this Agreement) refers to Do Eggs Cost More.
            </p>
        </li>
        <li>
            <p>
        ...
        <li>
            <p>
                <strong>Location Data</strong> refers to the approximate
                geographic location of the browser and IP address used to access
                the Service. This may include the approximate city, state,
                territory or country.
            </p>
        <li>
            <p>
                <strong>Website</strong> refers to Do Eggs Cost More, accessible
                from https://doeggscostmore.com
            </p>
        </li>
        <li>
            <p>
    ...
    <h4>Location Data</h4>
    <p>
        We collect your approximate geographic location based on the IP address
        used to access the Service. This may include your Country, State or
        territory, or City.
    </p>
    <p>
    ...
    <ul>
        <li>
            ...
            file placed on Your Device. You may opt out of any non-essential
            cookies. See the Opting Out section below.
        </li>
    </ul>
    <p>
    ...
    <p>
        You have the right to opt out of any extra data collection. There are
        multiple ways to opt out:
    </p>
    <ul>
        <li>
            Click the "Opt Out" button that appears in the pop up on the bottom
            of each page. If you've dismissed the pop-up or already opted-out,
            it won't re-appear.
        </li>
        <li>
            Clicking this link: <b><a href="#" id="trackingoptout">Click here to
            opt out
    ...
    <p>
        You have the right to request your information be deleted, however we do
        not collect enough identifying information correlate a deletion request
        with user data.
    </p>
    ...
    <p>
        We may update Our Privacy Policy from time to time. We will update the
        &quot;Last updated&quot; date at the top of this Privacy Policy and make
        a show a notice when any changes are made.
    </p>
    <p>
